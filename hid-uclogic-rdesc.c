...
const __u8 uclogic_rdesc_xppen_artist22_pro_fixed_arr[] = {
//	0x05, 0x0D,                     /*  Usage Page (Digitizer),                 */
//	0x09, 0x02,                     /*  Usage (Pen),                            */
//	0xA1, 0x01,                     /*  Collection (Application),               */
//	0x85, 0x07,                     /*      Report ID (7),                      */
...
const size_t uclogic_rdesc_xppen_artist22_pro_fixed_size =
			sizeof(uclogic_rdesc_xppen_artist22_pro_fixed_arr);
